...
namespace SupportTicketing.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260820171557_NotificationPopupFlag")]
    partial class NotificationPopupFlag
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SupportTicketing.Domain.Feedback.SatisfactionRating", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "RatedAgentId", "SubmittedAtUtc")
                        .HasDatabaseName("IX_SatisfactionRatings_Org_Agent_Submitted");

                    b.ToTable("SatisfactionRatings", null, t =>
                        {
                            t.HasCheckConstraint("CK_SatisfactionRatings_Agent", "[AgentRating] IS NULL OR [AgentRating] BETWEEN 1 AND 5");
            ...
            modelBuilder.Entity("SupportTicketing.Domain.Tickets.Ticket", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "AssignedAgentId", "Status", "Priority")
            ...
            modelBuilder.Entity("SupportTicketing.Domain.Tickets.Ticket", b =>
                {
                    ...
                    b.HasOne("SupportTicketing.Domain.Identity.User", "AssignedAgent")
                        .WithMany()
            ...
            modelBuilder.Entity("SupportTicketing.Domain.Tickets.TicketAssignment", b =>
                {
                    b.HasOne("SupportTicketing.Domain.Identity.User", "NewAgent")
                        .WithMany()
